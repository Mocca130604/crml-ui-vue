...
export interface CrmlBouncyButtonProps {
  variant?: 'blue' | 'primary' | 'lime' | 'pink' | 'cyan' | 'yellow' | 'white' | 'obsidian' | 'grad-y2k' | 'grad-acid';
...
/* Variants */
.crml-bouncy-button--primary, .crml-bouncy-button--blue { background-color: var(--crt-ryo-blue-500, #1B6FFF); color: #FFFFFF; }
