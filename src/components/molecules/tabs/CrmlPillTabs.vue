...
.crml-pill-tabs--obsidian .crml-pill-tab-item--active { background-color: var(--crt-obsidian); color: var(--crml-action-primary) !important; border-color: var(--crml-action-primary); box-shadow: 2px 2px 0px var(--crml-shadow-ink, #0D0D0D); }
