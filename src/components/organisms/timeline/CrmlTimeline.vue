...
.badge-success,
.badge-lime { background-color: var(--crml-action-primary, #1B6FFF); color: var(--crml-text-on-accent, #0d0d0d); }
.badge-primary,
...
.badge-obsidian { background-color: var(--crt-obsidian, #0d0d0d); color: var(--crml-action-primary, #1B6FFF); }

.node-lime { background-color: var(--crml-action-primary, #1B6FFF) !important; color: var(--crml-text-on-accent, #0d0d0d) !important; }
...
.node-obsidian { background-color: var(--crt-obsidian, #0d0d0d) !important; color: var(--crml-action-primary, #1B6FFF) !important; }
